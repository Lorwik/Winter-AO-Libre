...
Public EXPI As Integer
Public OROI As Integer

'LwKSecure anti editados
Public Const ClaveSeguridad As String * 18 = "LIK229X1U%REXD-"
'/LwKSecure anti editados

Public ObjSlot1 As Byte
Public ObjSlot2 As Byte

Public CastilloOESTE As String 'CLAN DUEÑO
...
Public OESTE As Integer 'NUMERO DEL MAPABUSCAR:
...
Public Subastando As Boolean 'Subastas de EAO Extraido por lorwik
...
Public Const FONTTYPE_GM As String = "~255~255~255~1~1"
Public Const FONTTYPE_LORWIK As String = "~255~255~255~0~1"
Public Const FONTTYPE_LORWIAD As String = "~0~195~255~0~1"
...
Public Const FONTTYPE_PROMEDIO As String = "~255~255~0~1~0"
Public Const FONTTYPE_CELESTE_NEGRITA As String = "~0~128~255~1~0"
 Public STAT_MAXELV As Byte
 Public STAT_MAXHP As Integer
 Public STAT_MAXSTA As Integer
 Public STAT_MAXMAN As Integer
 Public STAT_MAXHIT_UNDER36 As Byte
 Public STAT_MAXHIT_OVER36 As Integer
 Public STAT_MAXDEF As Byte ' /Peto
...
' Le damos los atributos al objeto.
    ...
    RazaProhibida(1 To NUMRAZAS) As String
...
Public Type SubastaBanco
    ObjIndex As Integer
    Amount As Integer 'Subastas de EAOExtraido por lorwik
End Type
...
Public Type UserFlags
    ...
    ParticipaSubasta As Boolean 'Subastas de EAO Extraido por lorwik
    Descuento As String
...
End Type
Public lstEncript(32 To 64) As String
'Tipo de los Usuarios
Public Type User
    name As String
    ID As Long
    
    sID As Byte ' Security ID
