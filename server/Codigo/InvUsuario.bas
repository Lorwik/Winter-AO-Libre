...
If ObjData(ObjIndex).RazaProhibida(1) <> "" Then
    Dim i As Integer
    For i = 1 To NUMRAZAS
        If ObjData(ObjIndex).RazaProhibida(i) = UCase$(UserList(UserIndex).Raza) Then
...
If Slot > MAX_INVENTORY_SLOTS Then
   ...
   Do Until UserList(UserIndex).Invent.Object(Slot).ObjIndex = 0
       ...
       If Slot > MAX_INVENTORY_SLOTS Then
           ...
           Call SonidosMapas.ReproducirSonido(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).pos.Map, 182)
...
Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).pos.Map, "LWK" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aura)
...
Select Case Obj.OBJType
    Case eOBJType.otWeapon
       ...
       RazaPuedeUsarItem(UserIndex, ObjIndex) And _
...
Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).pos.Map, "LWK" & UserList(UserIndex).Char.CharIndex & "," & UserList(UserIndex).Char.Aura)
    ...
    Case eOBJType.otFlechas
       ...
       RazaPuedeUsarItem(UserIndex, UserList(UserIndex).Invent.Object(Slot).ObjIndex) And _
    ...
    Case eOBJType.otPociones
        ...
        Select Case UserList(UserIndex).flags.TipoPocion
            ...
            Case 1 'Modif la agilidad
                ...
                If UserList(UserIndex).Stats.UserAtributos(eAtributos.Agilidad) > 3 * UserList(UserIndex).Stats.UserAtributosBackUP(Agilidad) Then UserList(UserIndex).Stats.UserAtributos(eAtributos.Agilidad) = 3 * UserList(UserIndex).Stats.UserAtributosBackUP(Agilidad)
        ...
        Call SendData(ToPCArea, UserIndex, UserList(UserIndex).pos.Map, "PG" & UserList(UserIndex).Stats.UserAtributos(Agilidad))
            ...
            Case 2 'Modif la fuerza
                ...
                If UserList(UserIndex).Stats.UserAtributos(eAtributos.Fuerza) > 3 * UserList(UserIndex).Stats.UserAtributosBackUP(Fuerza) Then UserList(UserIndex).Stats.UserAtributos(eAtributos.Fuerza) = 3 * UserList(UserIndex).Stats.UserAtributosBackUP(Fuerza)
