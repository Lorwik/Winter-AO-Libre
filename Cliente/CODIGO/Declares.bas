...
Public UsersID As Byte
Public lstEncript(32 To 64) As String
'TYa estamos cliente eencriptacion
...
Public Servidor(1 To 10) As Servidores


Public PanelsitoY As Boolean
...
'Lorwik> Esta son las opciones del Launcher
Public MPTres As Boolean
...
'Sonidos
Public Const SND_PASOS5 As String = "x23.wav"
Public Const SND_PASOS6 As String = "x24.wav"
Public Const SND_CLICK As String = "click.Wav"
Public Const SND_PASOS1 As String = "64.Wav"
Public Const SND_PASOS2 As String = "66.Wav"
Public Const SND_NAVEGANDO As String = "50.wav"
Public Const SND_EQUITANDO As String = "162.wav"
Public Const SND_PASOS3 As String = "243.Wav"
Public Const SND_PASOS4 As String = "244.Wav"
Public Const SND_GALOPE As String = "245.wav"
